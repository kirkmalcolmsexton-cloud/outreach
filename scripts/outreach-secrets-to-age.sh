...
#
# This is a thin wrapper around scripts/encrypt-secrets.sh (age encryption + jq
# validation of development_api_key and google_services). Prefer running from the repo root:
#
...
exec "${OUTREACH_ROOT}/scripts/encrypt-secrets.sh" "$@"
